...
class famousOperation extends StatefulWidget {

  List list;
  int index;
  String id;

  famousOperation({Key key,this.list,this.index,this.id}) : super(key: key);

  _famousOperationState createState() => _famousOperationState();
}

class _famousOperationState extends State<famousOperation> with SingleTickerProviderStateMixin{
                              ...
                              action: SnackBarAction(
                                ...
                                onPressed: (){
                                    ...
                                    userToken.then((String userToken)async{
                                      print(widget.id);
                                      deleteListFamous(userToken,widget.id);
                                    });
